...
const dreams: DreamCard[] = [
  {
    ...
    description:
      "Supporting each other's ambitions, celebrating each promotion, being each other's biggest cheerleader as we grow professionally.",
  },
  {
    icon: <Plane size={32} />,
    title: 'Exploring the World',
    description:
      "All those places we've talked about—Paris sunsets, Tokyo nights, quiet beaches where we can just be together. Adventures waiting for us.",
  },
  {
    icon: <Home size={32} />,
    title: 'A Home of Our Own',
    description:
      "A cozy place that's ours. Morning coffee on the balcony, lazy Sunday mornings, building a life brick by brick, together.",
  },
  {
